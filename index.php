          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="https://yuza.fercel.app" class="app-brand-link gap-2">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Sistem Pendukung Keputusan! 👋</h4>
              <p class="mb-4">Silakan masuk ke akun Anda dan mulai petualangan</p>

              <form id="formAuthentication" class="mb-3" action="home.php" method="POST">
                <div class="mb-3">
